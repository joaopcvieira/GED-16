...
Tem-se, para o primeiro modelo, que o ajuste obtido foi de: 
'life_expectancy = 72.8 - 0.5 * birth_rate + 0.7 * expected_schooling + 0.005 * milk_consumption_pc'
...
De maneira análoga à anterior, tem-se que o modelo corresponde a:
`life_expectancy` = 30.82 + 4.5 * `log_gdp` -0.2 * `no_water` + 0.003 * `urban_population_percent`
...
=======
>>>>>>> 967c6031d30259b4cef07cfd5765c5a5540a8ec3
