...
Nota-se que, excessão feita à variável `deaths_air_pollution`, nenhum outro ajuste apresenta resíduos padronizados com valor absoluto maior que 3. Então, de modo geral, não se verifica observações extremas e não se pode indicar com precisão possíveis *outliers*.
