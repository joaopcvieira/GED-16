...
Ao obversar a tabela anova, conclui-se adicionar as interações entre a variável `continent` com as outras variáveis explicativas do modelo não traz nenhuma melhoria no modelo ao observarmos seu valor-p