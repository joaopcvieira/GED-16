...
```{r}
# Modelo de regressão linear com as variáveis explicativas "birth_rate_c", "expected_schooling_c" e "new_milk_consumption_pc_c"

# Modelo polinomial de segunda ordem completo com as variáveis quantitativas
model1_quant <- lm(life_expectancy ~ I(birth_rate_c^2) + I(expected_schooling_c^2) + I(new_milk_consumption_pc_c^2) + birth_rate_c * expected_schooling_c + birth_rate_c * new_milk_consumption_pc_c + expected_schooling_c * new_milk_consumption_pc_c, data = model1_data)
