...
É possível observar que as correlações diminuíram para todas as variáveis explicativas quantitativas do modelo após centralizadas pela média dos valores.
...
model1_quant <- lm(life_expectancy ~ I(birth_rate_c^2) + I(expected_schooling_c^2) + I(milk_consumption_pc_c^2) + birth_rate_c*expected_schooling_c + birth_rate_c*milk_consumption_pc_c + birth_rate_c*milk_consumption_pc_c, data = model1_data )
